...
/* package */ class SignInButton extends LinearLayout {
    /** Image left margin. */
    private static final int IMAGE_LEFT_MARGIN = (int) dp(8);

    /** Image right margin. */
    private static final int IMAGE_RIGHT_MARGIN = (int) dp(8);

    /** Text left margin. */
    private static final int TEXT_LEFT_MARGIN = (int) dp(2);

    /** Text right margin. */
    private static final int TEXT_RIGHT_MARGIN = (int) dp(8);
    ...
    /* package */ SignInButton(final Context context, @Nullable final AttributeSet attrs,
        ...
        final LayoutParams imageLayoutParams
        ...
        final LayoutParams textViewLayoutParams
            = new LayoutParams(LayoutParams.MATCH_PARENT, LayoutParams.MATCH_PARENT);
        textViewLayoutParams.setMargins(
            (int)dp(TEXT_LEFT_MARGIN), 0, (int)dp(TEXT_RIGHT_MARGIN), 0);
     ...
     */
    protected static float dp(final int dp) {
    ...
    private Drawable getButtonBackground(final int buttonFaceColor) {
        ...
        final RoundRectShape insetBackgroundRect = new RoundRectShape(
            new float[]{
                dp(cornerRadius), dp(cornerRadius), dp(cornerRadius), dp(cornerRadius),
                dp(cornerRadius), dp(cornerRadius), dp(cornerRadius), dp(cornerRadius)},
            null, null);
        final ShapeDrawable insetBackgroundDrawable = new ShapeDrawable(insetBackgroundRect);
        insetBackgroundDrawable.getPaint().setColor(buttonFaceColor);
